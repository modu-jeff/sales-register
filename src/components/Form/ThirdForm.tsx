...
const ThirdForm = ({ register, watch }: { register: UseFormRegister<FormValues>; watch: UseFormWatch<FormValues> }) => {
    ...
    <>
      ...
      <div style={{ margin: '2rem 0' }}>
        <label>
          ...
          <input type="text" placeholder="담당자 이름" {...register('userName')} />
        </label>
      </div>
      <div style={{ margin: '2rem 0' }}>
        <label>
          <span style={{ marginRight: '1rem' }}>휴대폰 번호</span>
          <input type="tel" placeholder="숫자만 입력" {...register('phoneNumber')} />
        </label>
      ...
      <div style={{ margin: '2rem 0' }}>
        <label>
          ...
          <input type="text" placeholder="추천코드 입력" {...register('recommendCode')} />
        </label>
      </div>
      <div style={{ margin: '2rem 0' }}>
        <div>개인정보 수집에 동의</div>
